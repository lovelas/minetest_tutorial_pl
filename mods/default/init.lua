...
default.gui_controls = minetest.formspec_escape("[left click]: take/drop stack;   [right click]: take half / drop 1;   [middle click]: take 10 / drop 10;   [Esc] or [I]: Close")
...
default.gui_suvival_form = "size[8,8.5]"..
			...
			default.gui_bg_img..
			default.gui_slots..
			"button_exit[-0.1,-0.3;2,1;gotostart;Back to start]"..
